...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="hero-status-bar w-full relative z-10 bg-white/80 backdrop-blur-md md:backdrop-blur-xl border-t border-neutral-200 shadow-sm"
        data-aos="fade-up"
        data-aos-delay="200"
      >
        <div className="container mx-auto px-6 sm:px-8 md:px-12 py-3 sm:py-3.5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs sm:text-sm tracking-wider uppercase font-mono">
          ...
          <div className="flex flex-wrap items-center justify-center sm:justify-end gap-3 sm:gap-4">
            <div className="flex items-center gap-3">
              {/* Instagram */}
              <a
                href="https://www.instagram.com/musyaa_3?igsh=MXFkMHh2empvbzRnbA=="
                target="_blank"
              ...
              {/* Facebook */}
              <a
                href="https://www.facebook.com/share/1KtsbCGuYP/"
                target="_blank"
                rel="noopener noreferrer"
                className="!text-black hover:opacity-70 transition-opacity p-1 rounded hover:bg-black/5"
                aria-label="Facebook"
