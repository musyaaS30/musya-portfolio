  ...
  const socialLinks = [
    {
      ...
      color: "hover:text-red-500 hover:bg-red-500/10 hover:border-red-500/40",
      svg: (
    ...
    },
    {
      ...
      color: "hover:text-blue-600 hover:bg-blue-600/10 hover:border-blue-600/40",
      svg: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      color: "hover:text-sky-600 hover:bg-sky-600/10 hover:border-sky-600/40",
      svg: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      color: "hover:text-pink-600 hover:bg-pink-600/10 hover:border-pink-600/40",
      svg: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      color: "hover:text-neutral-900 hover:bg-neutral-900/10 hover:border-neutral-900/40 dark:hover:text-white dark:hover:bg-white/10 dark:hover:border-white/40",
      svg: (
        <svg className="w-5 h-5 sm:w-6 sm:h-6 fill-current" viewBox="0 0 24 24">
          <path
            fillRule="evenodd"
