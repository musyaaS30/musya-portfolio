                ...
                <div className="flex items-center justify-between sm:justify-around px-2 sm:px-6">
                  {socialLinks.map((item, idx) => (
                    <a
                      ...
                      className="group/icon relative p-1.5 sm:p-2 text-neutral-500 hover:text-neutral-800 dark:text-neutral-400 dark:hover:text-white transition-all duration-200 ease-out hover:scale-125 hover:-translate-y-1 drop-shadow-[0_2px_5px_rgba(0,0,0,0.12)]"
                      title={item.name}
