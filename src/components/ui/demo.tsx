      ...
      <div className="flex w-full max-w-xs flex-col items-center gap-4 rounded-2xl border border-border bg-card p-5 text-center shadow-xs">
        ...
        <div className="flex w-full flex-col gap-2">
          <button
            ...
            className="flex w-full cursor-pointer items-center justify-between rounded-full border border-border bg-background px-3.5 py-2 text-xs font-semibold text-foreground shadow-xs transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring outline-none"
          >
          ...
          <div className="mt-1 flex items-center gap-2">
            <button
              ...
              className="flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-full border border-border bg-background py-2 text-[11px] font-semibold text-foreground shadow-xs transition-colors hover:bg-accent focus-visible:ring-2 focus-visible:ring-ring outline-none"
            >
              {showLogo ? (
